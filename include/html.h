...
// BODY
   "<body>\n"
    "<h2>HomeAtmo</h2>\n"
        "<div><h3>Temperature</h3><canvas id=\"chart-temperature\"></canvas><p id=\"temp\">0</p></div>\n"
        "<br />"
        "<br />"
        "<div><h3>Humidity</h3><canvas id=\"chart-humidity\"></canvas><p id=\"hum\">0</p></div>\n"
        "<br />"
        "<br />"
        "<div><h3>Pressure</h3><canvas id=\"chart-pressure\"></canvas><p id=\"press\">0</p></div>\n"
        "<br />"
        "<br />"
        "<div><h3>Indoor Air Quality (IAQ)</h3><canvas id=\"chart-iaq\"></canvas><p id=\"iaq\">0</p></div>\n"
        "<br />"
        "<br />"
